//! Starship prompt studio (experimental).
//!
//! Config I/O, shell integration, presets, and prompt preview.
...
use crate::backup;
use crate::experimental::starship::model::{ShellKind, ShellStatus, StarshipModel};
use std::fs;
