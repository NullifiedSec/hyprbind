//! Waybar config I/O, process control, and JSONC helpers.
...
fn load_style(path: &Path) -> String {
    fs::read_to_string(path).unwrap_or_else(|_| crate::waybar_style::DEFAULT_STYLE.to_string())
}
